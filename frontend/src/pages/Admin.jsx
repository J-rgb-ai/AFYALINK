  ...
  return (
    <div style={{
      ...
      <header style={{
        ...
        <div>
          <h1 style={{ margin: 0, fontSize: '1.5rem' }}>AFYALINK - Admin Dashboard</h1>
          <div style={{ fontSize: '0.875rem', color: '#e2e8f0' }}>
            {currentUser ? `Welcome, ${currentUser.fullName} (${currentUser.uniqueId})` : 'Admin'}
          </div>
        </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <h3>System Health</h3>
                <p style={{ fontSize: '2rem', fontWeight: 'bold', margin: 0 }}>98%</p>
              </div>
            </div>
            <div>
              <h3>Quick Actions</h3>

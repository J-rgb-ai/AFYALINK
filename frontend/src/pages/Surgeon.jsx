  ...
  return (
    <div style={{
      ...
      <header style={{
        ...
        <div>
          <h1 style={{ margin: 0, fontSize: '1.5rem' }}>AFYALINK - Surgeon Dashboard</h1>
          <div style={{ fontSize: '0.875rem', color: '#e2e8f0' }}>
            {currentUser ? `Welcome, ${currentUser.fullName} (${currentUser.uniqueId})` : 'Surgeon'}
          </div>
        </div>
      ...
      <div style={{
        ...
        <main>
          <div style={{
            ...
            <h2 style={{ marginTop: 0 }}>Surgeon Overview</h2>
            <p>Manage surgical procedures, patient care, and operating room schedules.</p>
            <div style={{
              display: 'grid',

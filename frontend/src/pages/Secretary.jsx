  ...
  return (
    <div style={{
      ...
      <header style={{
        ...
        <div>
          <h1 style={{ margin: 0, fontSize: '1.5rem' }}>AFYALINK - Secretary Dashboard</h1>
          <div style={{ fontSize: '0.875rem', color: '#e2e8f0' }}>
            {currentUser ? `Welcome, ${currentUser.fullName} (${currentUser.uniqueId})` : 'Secretary'}
          </div>
        </div>
      ...
      <div style={{
        ...
        <main>
          <div style={{
            ...
            <h2 style={{ marginTop: 0 }}>Secretary Overview</h2>
            <p>Manage appointments, communications, and administrative tasks.</p>
            <div style={{
              display: 'grid',

...
--CREATE USER 'doctor'@'localhost' IDENTIFIED BY 'docPass!';--
--CREATE USER 'nurse'@'localhost' IDENTIFIED BY 'nursepass';
--CREATE USER 'surgeon'@'localhost' IDENTIFIED BY 'surgeonpass';
--CREATE USER 'labtech'@'localhost' IDENTIFIED BY 'labtechpass';
--CREATE USER 'accounts_clerk'@'localhost' IDENTIFIED BY 'clerkpass';
--CREATE USER 'referral_mgr'@'localhost' IDENTIFIED BY 'refmanpass';
...
CREATE TABLE referrals(
    ...
    reffering_user_id INT NOT NULL, 
    reffering_facility_id INT NOT NULL, 
    receiving_facility_id INT NOT NULL, 
    reason TEXT,
    priority ENUM('Routine','Urgent','Emergency') DEFAULT 'Routine',
    referral_hash VARCHAR(255), 
